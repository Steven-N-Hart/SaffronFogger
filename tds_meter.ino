float getPPM()
{
  // Turn on the power tothe positive wire
  digitalWrite(TdsSensorPin, HIGH);
  delay(10); 
  // Take 20 readings
  ...
  // Turn off the power to prevent corrosion
  digitalWrite(TdsSensorPin, LOW);
    
  // Now use those reading to get the median value of PPM
